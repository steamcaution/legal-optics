...
export const ServiceNav = styled.div`
  ...
  &::before {
    ...
    right: 0;
    height: 1px;
    background: rgba(34, 103, 121, 0.15);
  }
`;
...
export const PricingWrapper = styled.div`
  text-align: center;
  padding: 80px 20px;     // 위아래 공간 넉넉하게
  margin: 0 auto;
  background: #0b161e;    // ★ 추가
`;
...
export const PricingCard = styled.div`
  ...
  display: flex;
  flex-direction: column;
  justify-content: space-between;   /* ★ 위 콘텐츠 + 아래 버튼 배치 */
  align-items: center;
                /* ★ 높이 균일화 */
  ...
  .content {
    ...
    align-items: center;
    gap: 6px;
    margin-bottom: 20px;            /* ★ 버튼과 간격 균일하게 */
  }
