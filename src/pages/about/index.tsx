    ...
    <>
      ...
      <SolutionsSection id="solutions">
        <div className="container">
          ...
          <SectionLead>
            AI 기반 법률 문서 자동화로 업무 효율을 극대화하세요
          </SectionLead>
          <SolutionsGrid>
            <SolutionCard>
              ...
              <h3>거래 내역 도표화</h3>
              <p>
                복잡한 금융 거래내역을 한눈에 파악할 수 있는 시각적 도표로 자동
                변환합니다.
              </p>
              <FeatureList>
            ...
            <SolutionCard>
              ...
              <h3>부채 증명서 자동 입력</h3>
              <p>
                각종 채무 증명서류를 AI가 자동으로 읽고 정리하여 실무에 바로
                활용 가능한 형태로 제공합니다.
              </p>
              <FeatureList>
                <li>채무 증명서 OCR 인식</li>
            ...
            <SolutionCard>
              ...
              <h3>소명자료 초안 작성</h3>
              <p>
                소명에 필요한 자료를 분석하여 초안을 자동 작성, 변호사의 검토
                시간을 대폭 단축합니다.
              </p>
              <FeatureList>
                <li>문서 내용 자동 분석</li>
          ...
          <TechContent>
            <TechProblemSolution>
              <ProblemBox>
                ...
                <ul>
                  ...
                  <li>숫자/법률 용어 오인식</li>
                  <li>
                    좌표, 필드 매핑 오류로 인해 법률 문서 내 핵심 정보 추출 실패
                  </li>
                  <li>
                    인감, 도장, 테이블, 수기 메모 등 다양한 형식이 섞여 인식
                    실패
                  </li>
                </ul>
              </ProblemBox>
              <SolutionBox>
                ...
                <ul>
                  ...
                  <li>
                    표, 항목, 도장 영역을 자동 탐지하여 영역별 최적 OCR 수행
                  </li>
            ...
            <CompetitiveGrid>
              <CompetitiveCard>
                ...
                <h4>AI + OCR 기술</h4>
                <p>
                  법률 문서 자동 인식 및 텍스트 추출, 자체 개발 AI 모듈로 문서
                  인식 정확도 개선
                </p>
              </CompetitiveCard>
              <CompetitiveCard>
                ...
                <h4>맞춤형 처리</h4>
                <p>
                  금융사별 거래내역서 맞춤형 처리, 실무 활용 가능한 데이터 형태
                  제공
                </p>
              </CompetitiveCard>
              <CompetitiveCard>
                ...
                <h4>모듈화 구조</h4>
                <p>
                  다양한 문서/금융 데이터 확장성 확보, 새로운 문서 유형 추가
                  용이
                </p>
              </CompetitiveCard>
              <CompetitiveCard>
                ...
                <h4>직관적 UI/UX</h4>
                <p>
                  실무자가 쉽게 문서 업로드 및 검토, 간편한 드래그앤드롭
                  인터페이스
                </p>
              </CompetitiveCard>
              <CompetitiveCard>
                ...
                <h4>합리적 가격</h4>
                <p>
                  경쟁사 대비 투명하고 합리적한 가격, SaaS 모델로 중소형 법률
                  사무소도 쉽게 도입
                </p>
              </CompetitiveCard>
            </CompetitiveGrid>
...
AboutUs.getLayout = function getLayout(
  page: ReactElement,
